...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("apiSecret", new ApiKeyAuth("header", "apiSecret"));
        ...
        if (configuration != null) {
            ...
            if (configuration.apiSecret != null) {
                this.setApiSecret(configuration.apiSecret);
            }
    ...
    public String getApiSecret() {
        return ((ApiKeyAuth) this.getAuthentication("apiSecret")).getApiKey();
    }

    public void setApiSecret(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("apiSecret")).setApiKey(apiKey);
    }

    public void setApiSecretPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("apiSecret")).setApiKeyPrefix(prefix);
    }
